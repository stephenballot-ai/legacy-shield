    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b">
          <div>
            <h2 className="text-lg font-semibold text-fg">Build Financial Overview</h2>
            <p className="text-xs text-fg-muted">List your banks and accounts. We&apos;ll generate a secure PDF for your vault.</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {entries.map((entry) => (
            <div key={entry.id} className="grid grid-cols-1 md:grid-cols-12 gap-3 p-3 bg-bg-sunken rounded-xl border border-line items-start">
              ...
              <div className="md:col-span-1 flex justify-end md:pt-2">
                <button 
                  ...
                  className="p-1.5 text-fg-subtle hover:text-danger rounded-lg transition-colors disabled:opacity-30"
                >
        ...
        <div className="p-4 border-t bg-bg-sunken rounded-b-xl flex items-center justify-between">
