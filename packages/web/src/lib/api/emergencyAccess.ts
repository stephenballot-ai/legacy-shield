...
export const emergencyAccessApi = {
  ...
  validateEmergencyPhrase: (ownerEmail: string, emergencyPhrase: string) =>
    api.post<ValidateEmergencyPhraseResponse>('/emergency-access/validate', { ownerEmail, emergencyPhrase }),
